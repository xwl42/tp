...
public class CommandTestUtil {
    ...
    public static final String INVALID_GITHUB_USERNAME_DESC = " " + PREFIX_GITHUB_USERNAME + "peter parker"; // username may only contain alphanumeric characters or hyphens
